<?php
$page_title = 'Glowing - Reveal The Beauty of Skin';
  ...
  <div class="container">
    ...
    <ul class="has-scrollbar">
      ...
      <li class="scrollbar-item">
        <div class="hero-card has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/hero-banner-1.jpg')">
          ...
          <div class="card-content">
            ...
            <a href="<?php echo BASE_URL; ?>/public/shop.php" class="btn btn-primary">Shop Now</a>
      ...
      <li class="scrollbar-item">
        <div class="hero-card has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/hero-banner-2.jpg')">
      ...
      <li class="scrollbar-item">
        <div class="hero-card has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/hero-banner-3.jpg')">
    ...
    <ul class="collection-list">
      ...
      <li>
        <div class="collection-card has-before hover:shine">
          ...
          <a href="<?php echo BASE_URL; ?>/public/shop.php" class="btn-link">
            <span class="span">Shop Now</span>

            <ion-icon name="arrow-forward" aria-hidden="true"></ion-icon>
          </a>

          <div class="has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/collection-1.jpg')"></div>
      ...
      <li>
        <div class="collection-card has-before hover:shine">
          ...
          <div class="has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/collection-2.jpg')"></div>
      ...
      <li>
        <div class="collection-card has-before hover:shine">
          ...
          <div class="has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/collection-3.jpg')"></div>
...
<section class="section shop" id="shop" aria-label="shop" data-section>
  <div class="container">
    ...
    <ul class="has-scrollbar" id="bestsellers-list">
    ...
    <ul class="banner-list">
      ...
      <li>
        <div class="banner-card banner-card-1 has-before hover:shine">
          ...
          <a href="<?php echo BASE_URL; ?>/public/shop.php" class="btn btn-secondary">Explore More</a>

          <div class="has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/banner-1.jpg')"></div>
      ...
      <li>
        <div class="banner-card banner-card-2 has-before hover:shine">
          ...
          <a href="<?php echo BASE_URL; ?>/public/shop.php" class="btn btn-secondary">Shop Sale</a>

          <div class="has-bg-image" style="background-image: url('<?php echo BASE_URL; ?>/assets/images/banner-2.jpg')"></div>
    ...
    <ul class="flex-list">
      ...
      <li class="flex-item">
        <div class="feature-card">
          ...
          <img src="<?php echo BASE_URL; ?>/assets/images/feature-1.jpg" width="204" height="236" loading="lazy" alt="Guaranteed PURE"
            class="card-icon">
      ...
      <li class="flex-item">
        <div class="feature-card">
          ...
          <img src="<?php echo BASE_URL; ?>/assets/images/feature-2.jpg" width="204" height="236" loading="lazy"
      ...
      <li class="flex-item">
        <div class="feature-card">
          ...
          <img src="<?php echo BASE_URL; ?>/assets/images/feature-3.jpg" width="204" height="236" loading="lazy"
...
<section class="section offer" id="offer" aria-label="offer" data-section>
  <div class="container">
    ...
    <figure class="offer-banner">
      <img src="<?php echo BASE_URL; ?>/assets/images/offer-banner-1.jpg" width="305" height="408" loading="lazy" alt="offer products"
        class="w-100">

      <img src="<?php echo BASE_URL; ?>/assets/images/offer-banner-2.jpg" width="450" height="625" loading="lazy" alt="offer products"
        class="w-100">
    </figure>
    ...
    <ul class="flex-list">
      ...
      <li class="flex-item">
        <div class="blog-card">
          ...
          <figure class="card-banner img-holder has-before hover:shine" style="--width: 700; --height: 450;">
            <img src="<?php echo BASE_URL; ?>/assets/images/blog-1.jpg" width="700" height="450" loading="lazy" alt="Find a Store"
              class="img-cover">
          </figure>
      ...
      <li class="flex-item">
        <div class="blog-card">
          ...
          <figure class="card-banner img-holder has-before hover:shine" style="--width: 700; --height: 450;">
            <img src="<?php echo BASE_URL; ?>/assets/images/blog-2.jpg" width="700" height="450" loading="lazy" alt="From Our Blog"
              class="img-cover">
          </figure>
      ...
      <li class="flex-item">
        <div class="blog-card">
          ...
          <figure class="card-banner img-holder has-before hover:shine" style="--width: 700; --height: 450;">
            <img src="<?php echo BASE_URL; ?>/assets/images/blog-3.jpg" width="700" height="450" loading="lazy" alt="Our Story"
              class="img-cover">
          </figure>
...
document.addEventListener('DOMContentLoaded', () => {
    const apiUrl = `<?php echo BASE_URL; ?>/api/products.php?bestsellers=true&limit=8`;
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            if (data.status === 'success') {
                    ...
                    <li class="scrollbar-item">
                      <div class="shop-card">
                        <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                          <img src="<?php echo BASE_URL; ?>/assets/images/${product.image}" width="540" height="720" loading="lazy"
                        ...
                        <div class="card-content">
                          <div class="price">
                            <span class="span">$${parseFloat(product.price).toFixed(2)}</span>
                          </div>
                          <h3>
                            <a href="<?php echo BASE_URL; ?>/public/product.php?id=${product.id}" class="card-title">${product.name}</a>
                          </h3>
                ...
                bestsellersList.innerHTML = productsHtml;
            } else {
